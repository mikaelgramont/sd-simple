  ...
  .thumb-gallery img:hover {
    cursor: pointer;
		...
		<div class="wrapper">
          ...
          <a class="logo-wrapper" href="/"><span class="SVGInline styles__logoImage--2xXQT hollow">
              <svg class="SVGInline-svg logo hollow-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 202.96 202.96">
                <defs>
                    <style>
                        .cls-1 {
                          fill: #26a3bc;
